...
public class MenuController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "403", description = "Only admins can add menus"),
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Request validation failed"),
            @ApiResponse(responseCode = "403", description = "Only admins can update menus"),
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "403", description = "Only admins can delete menus"),
            @ApiResponse(responseCode = "404", description = "Restaurant or menu not found")
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "403", description = "Authentication or required role missing"),
            @ApiResponse(responseCode = "404", description = "Restaurant or menu not found")
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Menus returned successfully"),
            @ApiResponse(responseCode = "403", description = "Authentication or required role missing"),
            @ApiResponse(responseCode = "404", description = "Restaurant not found")
    })
